...
gulp.task("build-js", () => {
  return gulp
    .src(["./src/js/dashboard.js", "./src/js/login.js"], { allowEmpty: true })
    .pipe(named())
    .pipe(
      webpack({
        mode: "development",
...
gulp.task("copy-assets", () => {
  return gulp
    .src(["./src/assets/fonts/**/*.{woff,woff2}", "./src/assets/img/**"], {
      base: "./src/assets",
    })
...
gulp.task("watch", function () {
  ...
  gulp.watch(
    ["./src/assets/fonts/**/*.{woff,woff2}", "./src/assets/img/**"],
    () => {
      gulp.series(
        "copy-assets",
        "optimize-images",
